...
function buildManifest(parts) {
  ...
  const manifest = {
    ...
    cinematicPlan: parts.cinematicPlan,
    cinematicTimeline: parts.cinematicTimeline,
    cinematicBeatSheet: parts.cinematicBeatSheet,
    cinematicCameraPlan: parts.cinematicCameraPlan,
    cinematicGameFeelPlan: parts.cinematicGameFeelPlan,
    cinematicAudit: parts.cinematicAudit,
