...
function run() {
  ...
  assert(QaSwarm.createStatus().version === '0.74.0', 'QA version drift');
  assert(Cinematic.createStatus().version === '0.74.0', 'cinematic version drift');
  assert(AssetForge.createStatus().version === '0.74.0', 'assetforge version drift');
  assert(Worldgen.createStatus().version === '0.74.0', 'worldgen version drift');
  assert(Visual.createStatus().version === '0.74.0', 'visual version drift');
  assert(Premium.getStatus().version === '0.74.0', 'premium version drift');
