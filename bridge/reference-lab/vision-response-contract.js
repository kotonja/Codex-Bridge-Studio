...
function buildVisionReport({ intake, vision, modeOverride } = {}) {
  ...
  return base({
    ...
    apiVision: vision ? {
      ...
      errorType: vision.errorType || null,
      errorSummary: vision.errorSummary || null,
      safeRemediation: Array.isArray(vision.safeRemediation) ? vision.safeRemediation.slice(0, 8) : [],
    } : {
      configured: Boolean(intake && intake.apiConfigured),
      used: false,
      provider: null,
    ...
    errorType: vision && vision.errorType ? vision.errorType : null,
    safeRemediation: vision && Array.isArray(vision.safeRemediation) ? vision.safeRemediation.slice(0, 8) : [],
