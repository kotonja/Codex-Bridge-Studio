...
const toolHandlers = {
  ...
  execute_detail: async (args) => requestBridge('GET', `/codex/execution/detail?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium high-detail Roblox build')}`, undefined, 3500),
  execute_architecture: async (args) => requestBridge('GET', `/codex/execution/architecture?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium modular Roblox architecture')}`, undefined, 3500),
  ...
  ai_tls_check: async () => AiOrchestrator.getConnectivityReport({ source: 'mcp.aiTlsCheck' }),
  ai_connectivity: async () => AiOrchestrator.getConnectivityReport({ source: 'mcp.aiConnectivity' }),
  ...
  detail_status: async () => requestBridge('GET', '/codex/detail/status', undefined, 2500),
  detail_styles: async () => requestBridge('GET', '/codex/detail/styles', undefined, 2500),
  detail_plan: async (args) => requestBridge('GET', `/codex/detail/plan?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium high-detail Roblox build')}`, undefined, 2500),
  detail_compile: async (args) => requestBridge('GET', `/codex/detail/compile?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium high-detail Roblox build')}`, undefined, 2500),
  detail_portal: async (args) => requestBridge('GET', `/codex/detail/portal?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium portal gate')}`, undefined, 2500),
  detail_building: async (args) => requestBridge('GET', `/codex/detail/building?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium building facade')}`, undefined, 2500),
  detail_interior: async (args) => requestBridge('GET', `/codex/detail/interior?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium interior')}`, undefined, 2500),
  detail_path: async (args) => requestBridge('GET', `/codex/detail/path?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium readable path')}`, undefined, 2500),
  detail_props: async (args) => requestBridge('GET', `/codex/detail/props?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium prop clusters')}`, undefined, 2500),
  detail_lighting: async (args) => requestBridge('GET', `/codex/detail/lighting?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium lighting fixtures')}`, undefined, 2500),
  detail_material_swatches: async (args) => requestBridge('GET', `/codex/detail/material-swatches?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium material swatches')}`, undefined, 2500),
  detail_sockets: async (args) => requestBridge('GET', `/codex/detail/sockets?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium production sockets')}`, undefined, 2500),
  detail_budget: async (args) => requestBridge('GET', `/codex/detail/budget?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium high-detail Roblox build')}`, undefined, 2500),
  detail_audit: async (args) => requestBridge('GET', `/codex/detail/audit?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium high-detail Roblox build')}`, undefined, 2500),
  detail_polish: async (args) => requestBridge('GET', `/codex/detail/polish?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium high-detail Roblox build')}`, undefined, 2500),
  detail_execute_preview: async (args) => requestBridge('GET', `/codex/detail/execute-preview?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium high-detail Roblox build')}`, undefined, 2500),
  detail_manifest: async (args) => requestBridge('GET', `/codex/detail/manifest?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium high-detail Roblox build')}`, undefined, 2500),
  architecture_status: async () => requestBridge('GET', '/codex/architecture/status', undefined, 2500),
  architecture_styles: async () => requestBridge('GET', '/codex/architecture/styles', undefined, 2500),
  architecture_grammar: async (args) => requestBridge('GET', `/codex/architecture/grammar?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium modular Roblox architecture')}`, undefined, 2500),
  architecture_plan: async (args) => requestBridge('GET', `/codex/architecture/plan?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium modular Roblox architecture')}`, undefined, 2500),
  architecture_compile: async (args) => requestBridge('GET', `/codex/architecture/compile?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium modular Roblox architecture')}`, undefined, 2500),
  architecture_portal: async (args) => requestBridge('GET', `/codex/architecture/portal?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium portal architecture')}`, undefined, 2500),
  architecture_arch: async (args) => requestBridge('GET', `/codex/architecture/arch?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium arch grammar')}`, undefined, 2500),
  architecture_walls: async (args) => requestBridge('GET', `/codex/architecture/walls?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium modular walls')}`, undefined, 2500),
  architecture_roof: async (args) => requestBridge('GET', `/codex/architecture/roof?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium roof silhouette')}`, undefined, 2500),
  architecture_windows: async (args) => requestBridge('GET', `/codex/architecture/windows?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium window rhythm')}`, undefined, 2500),
  architecture_doors: async (args) => requestBridge('GET', `/codex/architecture/doors?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium door rhythm')}`, undefined, 2500),
  architecture_pillars: async (args) => requestBridge('GET', `/codex/architecture/pillars?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium pillar grammar')}`, undefined, 2500),
  architecture_stairs: async (args) => requestBridge('GET', `/codex/architecture/stairs?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium stairs')}`, undefined, 2500),
  architecture_interior: async (args) => requestBridge('GET', `/codex/architecture/interior?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium interior modules')}`, undefined, 2500),
  architecture_trims: async (args) => requestBridge('GET', `/codex/architecture/trims?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium trim system')}`, undefined, 2500),
  architecture_variants: async (args) => requestBridge('GET', `/codex/architecture/variants?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium architecture variants')}`, undefined, 2500),
  architecture_budget: async (args) => requestBridge('GET', `/codex/architecture/budget?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium modular Roblox architecture')}`, undefined, 2500),
  architecture_audit: async (args) => requestBridge('GET', `/codex/architecture/audit?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'premium modular Roblox architecture')}`, undefined, 2500),
  ...
  materials_status: async () => requestBridge('GET', '/codex/materials/status', undefined, 2500),
  materials_styles: async () => requestBridge('GET', '/codex/materials/styles', undefined, 2500),
  materials_palette: async (args) => requestBridge('GET', `/codex/materials/palette?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'dark purple anime dungeon gate')}`, undefined, 2500),
  materials_plan: async (args) => requestBridge('GET', `/codex/materials/plan?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'dark purple anime dungeon gate')}`, undefined, 2500),
  materials_swatches: async (args) => requestBridge('GET', `/codex/materials/swatches?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'dark purple anime dungeon gate')}`, undefined, 2500),
  materials_apply_plan: async (args) => requestBridge('GET', `/codex/materials/apply-plan?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'dark purple anime dungeon gate')}`, undefined, 2500),
  materials_lighting: async (args) => requestBridge('GET', `/codex/materials/lighting?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'dark purple anime dungeon gate')}`, undefined, 2500),
  materials_atmosphere: async (args) => requestBridge('GET', `/codex/materials/atmosphere?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'dark purple anime dungeon gate')}`, undefined, 2500),
  materials_fixtures: async (args) => requestBridge('GET', `/codex/materials/fixtures?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'dark purple anime dungeon gate')}`, undefined, 2500),
  materials_glow: async (args) => requestBridge('GET', `/codex/materials/glow?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'dark purple anime dungeon gate')}`, undefined, 2500),
  materials_mobile_budget: async (args) => requestBridge('GET', `/codex/materials/mobile-budget?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'dark purple anime dungeon gate')}`, undefined, 2500),
  materials_audit: async (args) => requestBridge('GET', `/codex/materials/audit?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'dark purple anime dungeon gate')}`, undefined, 2500),
  materials_polish: async (args) => requestBridge('GET', `/codex/materials/polish?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'dark purple anime dungeon gate')}`, undefined, 2500),
  materials_execute_preview: async (args) => requestBridge('GET', `/codex/materials/execute-preview?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'dark purple anime dungeon gate')}`, undefined, 2500),
  materials_manifest: async (args) => requestBridge('GET', `/codex/materials/manifest?goal=${encodeURIComponent(args.goal || args.intent || args.text || 'dark purple anime dungeon gate')}`, undefined, 2500),
...
const toolDefinitions = [
  ...
  ['execute_detail', 'Compile a V89 high-detail build plan into V72 Codex-owned preview actions without applying.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ...
  ['ai_tls_check', 'Run V86.1 OpenAI API TLS/certificate connectivity diagnostics without exposing secrets.', {}],
  ['ai_connectivity', 'Run V86.1 OpenAI API connectivity diagnostics including TLS, DNS, auth, timeout, and extra CA status.', {}],
  ...
  ['detail_status', 'Return V89 High-Detail Build Compiler readiness, safety, roots, and integrations.', {}],
  ['detail_styles', 'List V89 high-detail style catalogs with shape, trim, material, lighting, prop, socket, forbidden, and mobile hints.', {}],
  ['detail_plan', 'Plan a V89 high-detail build pass from intent without mutating Studio.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['detail_compile', 'Compile V89 high-detail geometry, trim, bevel illusion, prop, lighting, socket, material, and collision operations. No apply.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['detail_portal', 'Return a focused V89 portal/gate detail plan with layered architecture and sockets.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['detail_building', 'Return a focused V89 building/facade detail plan with trim and readable signage.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['detail_interior', 'Return a focused V89 interior room/shell detail plan.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['detail_path', 'Return a focused V89 path/edge/readability detail plan.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['detail_props', 'Return V89 prop-cluster details such as crystals, quest boards, chests, and prompt sockets.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['detail_lighting', 'Return V89 lighting fixture and beacon detail plan with mobile-aware light counts.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['detail_material_swatches', 'Return V89 material swatches and style notes for a build intent.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['detail_sockets', 'Return V89 VFX/audio/camera/prompt/QA socket markers for generated detail packages.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['detail_budget', 'Return V89 part/light/particle/mobile budget report.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['detail_audit', 'Audit V89 detail output for silhouette, trim depth, material variety, sockets, collision, mobile budget, and premium feel.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['detail_polish', 'Return V89 staged polish actions to reduce placeholder feel and improve detail quality.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['detail_execute_preview', 'Return V72-compatible V89 detail execution preview actions. Does not apply Studio changes.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['detail_manifest', 'Return V89 detail manifest metadata and next commands.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['architecture_status', 'Return V91 Advanced Shape Grammar readiness, roots, safety, and integrations.', {}],
  ['architecture_styles', 'List V91 architecture style catalogs with silhouette, module grid, arch, roof, wall, window, door, pillar, trim, and mobile grammar.', {}],
  ['architecture_grammar', 'Return V91 architecture grammar policy for a goal: module grid, silhouette, depth, rhythm, sockets, and budget rules.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['architecture_plan', 'Plan V91 modular architecture without mutating Studio.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['architecture_compile', 'Compile V91 architecture operations for Codex-owned primitive architecture. No apply.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['architecture_portal', 'Return a focused V91 portal/gate architecture plan with plinth, pillars, arch, keystone, depth, crystals, sockets, collision, and mobile variant.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['architecture_arch', 'Return V91 arch and gate grammar for a goal.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['architecture_walls', 'Return V91 modular wall plan with bay rhythm, seams, depth panels, and sockets.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['architecture_roof', 'Return V91 roof and upper silhouette plan.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['architecture_windows', 'Return V91 window rhythm and frame grammar plan.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['architecture_doors', 'Return V91 door rhythm and frame grammar plan.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['architecture_pillars', 'Return V91 pillar/corner/support grammar plan.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['architecture_stairs', 'Return V91 stair/ramp/landing grammar plan.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['architecture_interior', 'Return V91 interior module plan with room graph, sightlines, route hierarchy, and sockets.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['architecture_trims', 'Return V91 trim-band, bevel-illusion, and material-break grammar plan.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['architecture_variants', 'Return V91 architecture variant plan for silhouettes, rooflines, detail density, and mobile simplification.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['architecture_budget', 'Return V91 mobile/performance budget report for modular architecture operations.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['architecture_audit', 'Audit V91 architecture for silhouette strength, modular consistency, arch quality, depth layering, rhythm, collision, and premium feel.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ...
  ['materials_status', 'Return V93 Material, Color, Lighting, and Atmosphere Realization readiness, safety, and roots.', {}],
  ['materials_styles', 'List V93 material and lighting style catalogs with palettes, glow rules, atmosphere language, and mobile hints.', {}],
  ['materials_palette', 'Create a V93 material/color palette using built-in Roblox Materials and Color3 values. No fake texture ids.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['materials_plan', 'Plan a V93 material, color, lighting, and atmosphere pass without mutating Studio.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['materials_swatches', 'Return V72-compatible swatch board operations for material/color/glow samples.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['materials_apply_plan', 'Return a Codex-owned material application policy and role mapping; non-Codex targets remain manualRequired.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['materials_lighting', 'Plan mobile-safe key/rim/accent/path/portal lighting without mutating global Lighting.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['materials_atmosphere', 'Create an atmosphere/fog/bloom/color-correction manifest plan; global Lighting apply is manualRequired by default.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['materials_fixtures', 'Return V72-compatible lantern/sconce/crystal/path/portal light fixture operations.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['materials_glow', 'Return V72-compatible Neon/glow accent operations with a strict glow budget.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['materials_mobile_budget', 'Audit the V93 light/glow plan against mobile-safe brightness, range, and count budgets.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['materials_audit', 'Score V93 palette, material discipline, trim contrast, glow discipline, lighting depth, atmosphere, and premium material feel.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['materials_polish', 'Return staged V93 polish actions for contrast, material roles, glow discipline, fixtures, atmosphere, and mobile light reduction.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['materials_execute_preview', 'Return V72-compatible V93 material swatches, fixtures, glow accents, and manifests. Does not apply Studio changes.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
  ['materials_manifest', 'Return V93 material profile manifest metadata and next commands.', { goal: { type: 'string' }, intent: { type: 'string' }, text: { type: 'string' } }],
